...
@Component({
  selector: 'app-cat-aventura',
  templateUrl: './cat-aventura.page.html',
  styleUrls: ['./cat-aventura.page.scss'],
})
export class CatAventuraPage implements OnInit {
  Juego: any [] = []
  ...
  ngOnInit() {
    this.servicioBD.dbState().subscribe((res) =>{
      if(res){
        this.servicioBD.fetchJuegoAventura().subscribe(item2 =>{
          this.Juego = item2;
        });
      }
    });
