...
@Component({
  selector: 'app-cat-carreras',
  templateUrl: './cat-carreras.page.html',
  styleUrls: ['./cat-carreras.page.scss'],
})
export class CatCarrerasPage implements OnInit {
  Juego: any [] = []
  ...
  ngOnInit() {
    this.servicioBD.dbState().subscribe((res) =>{
      if(res){
        this.servicioBD.fetchJuegoCarrera().subscribe(item2 =>{
          this.Juego = item2;
        });
      }
    });
